...
export class InitialSchema1750887836870 implements MigrationInterface {
  name = 'InitialSchema1750887836870';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "UQ_daily_order_counter_date" ON "daily_order_counter" ("date") WHERE "deletedAt" IS NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."UQ_daily_order_counter_date"`,
    );
