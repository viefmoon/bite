...
interface UseOrderStateReturn extends OrderState {
  ...
  setProcessedPendingProductsIds: React.Dispatch<React.SetStateAction<string[]>>;
  ...
  setShowModifyInProgressConfirmation: React.Dispatch<React.SetStateAction<boolean>>;
  setPendingModifyAction: React.Dispatch<React.SetStateAction<(() => void) | null>>;
  ...
  setAdjustmentToEdit: React.Dispatch<React.SetStateAction<OrderAdjustment | null>>;
  setHasUnsavedChanges: React.Dispatch<React.SetStateAction<boolean>>;
  
  // Setters for tracking states
  setOriginalOrderState: React.Dispatch<React.SetStateAction<OrderState['originalOrderState']>>;
...
export const useOrderState = (): UseOrderStateReturn => {
  ...
  const [editIsTemporaryTable, setEditIsTemporaryTable] = useState<boolean>(false);
  const [editTemporaryTableName, setEditTemporaryTableName] = useState<string>('');
  ...
  const [originalOrderState, setOriginalOrderState] = useState<OrderState['originalOrderState']>(null);
