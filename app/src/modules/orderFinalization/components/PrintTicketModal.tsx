...
import { ThermalPrinter } from '@/modules/printers/types/printer.types';
...
interface PrintTicketModalProps {
  ...
  onPrint: (printerId: string, ticketType: 'GENERAL' | 'BILLING') => Promise<void>;
}
...
export const PrintTicketModal: React.FC<PrintTicketModalProps> = ({
  ...
  const { data: printersResponse, isLoading: isLoadingPrinters } = usePrintersQuery({ page: 1, limit: 100 });
  const [selectedTicketType, setSelectedTicketType] = useState<'GENERAL' | 'BILLING'>('GENERAL');
      ...
      >
        ...
        <ScrollView style={styles.content}>
          ...
          <View style={styles.section}>
            ...
            <RadioButton.Group
              onValueChange={value => setSelectedTicketType(value as 'GENERAL' | 'BILLING')}
            ...
            >
              ...
              >
                <Surface style={[
                  ...
                  { 
                    ...
                    borderColor: selectedTicketType === 'GENERAL' ? theme.colors.primary : 'transparent',
              ...
              >
                <Surface style={[
                  ...
                  { 
                    backgroundColor: theme.colors.surface,
                    borderColor: selectedTicketType === 'BILLING' ? theme.colors.primary : 'transparent',
                  ...
                  >
                    <Surface
                      style={[
                        ...
                        { 
                          backgroundColor: theme.colors.surface,
                          borderColor: selectedPrinterId === printer.id ? theme.colors.primary : 'transparent',
                          borderWidth: selectedPrinterId === printer.id ? 2 : 0,
                        }
                      ]}
                    >
                      <View style={styles.radioContent}>
                        <RadioButton value={printer.id} color={theme.colors.primary} />
                        <View style={styles.radioTextContainer}>
                          <Text style={[styles.radioLabel, { color: theme.colors.onSurface }]}>
                            🖨️ {printer.name}
                          </Text>
