...
const errorCodeMessages: { [key in ApiErrorCode | string]?: string } = {
  ...
  [ERROR_CODES.REFRESH_FAILED]: "Tu sesión ha expirado. Por favor, inicia sesión nuevamente.",
  ...
  'RATE_LIMIT_EXCEEDED': "Has realizado demasiadas solicitudes. Intenta más tarde.",
  ...
  'ORDER_CANNOT_BE_MODIFIED': "Esta orden no puede ser modificada en su estado actual.",
